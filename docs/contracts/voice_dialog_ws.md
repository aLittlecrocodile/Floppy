...
```
ws(s)://<host>/voice/ws?token=<token>&voice_style=<style>
```
...
```jsonc
{"type": "user_text",      "text": "我今天睡不着", "is_final": false}  // ASR 识别结果，text 为累计文本（非增量）
{"type": "assistant_text", "text": "别担心，我陪着你。", "is_final": false} // 即将合成播报的一句（可作字幕）
{"type": "turn_end",       "text": null,            "is_final": true}  // 助手本轮播报结束
{"type": "error",          "text": "<错误信息>",     "is_final": false} // 出错
```
